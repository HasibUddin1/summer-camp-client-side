                        ...
                        <tbody>
                            {
                                ...
                                >
                                    ...
                                    <td className="text-center"><button disabled={singleClass.status === 'approved'} className={
                                    ...
                                    <td className="text-center"><button disabled={singleClass.role === 'instructor'} className={
